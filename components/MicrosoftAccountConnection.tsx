...
interface MicrosoftAccountConnectionProps {
  // Remove tutorId since we'll use the current user from context
}
...
export const MicrosoftAccountConnection: React.FC<MicrosoftAccountConnectionProps> = () => {
  ...
  const handleConnect = async () => {
    ...
    try {
      ...
      // The context will automatically update, which will trigger useEffect
    } catch (error) {
